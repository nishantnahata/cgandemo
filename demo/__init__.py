...
#
#             print('Time taken for epoch {} is {} sec. Gen_Loss: {} Disc_Loss: {} '.format(epoch + 1, time_taken,
...
#                                                              logits=disc_real_output)
#             disc_generated_loss = tf.losses.sigmoid_cross_entropy(
#                 multi_class_labels=tf.zeros_like(disc_generated_output),
#                 logits=disc_generated_output)
#             total_disc_loss = disc_real_loss + disc_generated_loss
#
#             loss.append(
#                 (gen_gan_loss, gen_l1_loss, total_gen_loss, disc_real_loss, disc_generated_loss, total_disc_loss))
#
#         loss = np.array(loss)
